...
import net.mnayak2.onlineshopping.exception.ProductNotFoundException;
...
public class PageController {
	...
	public ModelAndView index()
	{
		...
		logger.debug("Inside PageController index metho");
	...
	{		
		...
		System.out.println("2^^^^^showCategoryProducts"+category.getId());
